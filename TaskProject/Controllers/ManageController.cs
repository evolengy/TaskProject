...
namespace TaskProject.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            await db.AddLogAccess(user.Email, "Пользователь успешно изменил свой пароль",
        ...
        public async Task<IActionResult> Disable2fa()
        {
            ...
            await db.AddLogAccess(user.Email, "Пользователь отключил 2fa",
                Request.Headers["User-Agent"].ToString());
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorViewModel model)
        {
            ...
            await db.AddLogAccess(user.Email, "Пользователь включил 2fa",
                Request.Headers["User-Agent"].ToString());
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            await db.AddLogAccess(user.Email, "Пользователь сбросил свой ключ аутентификации",
                Request.Headers["User-Agent"].ToString());
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            await db.AddLogAccess(user.Email, "Пользователь сгенерировал ключ 2fa",
                Request.Headers["User-Agent"].ToString());
