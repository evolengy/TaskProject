...
namespace TaskProject.Migrations
{
    ...
    [Migration("20180425101105_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskProject.Attainment", b =>
                {
            ...
            modelBuilder.Entity("TaskProject.Class", b =>
                {
                    b.Property<int>("ClassId");
            ...
            modelBuilder.Entity("TaskProject.Guild", b =>
                {
            ...
            modelBuilder.Entity("TaskProject.GuildsReputation", b =>
                {
            ...
            modelBuilder.Entity("TaskProject.Mission", b =>
                {
            ...
            modelBuilder.Entity("TaskProject.MissionsCondition", b =>
                {
            ...
            modelBuilder.Entity("TaskProject.ApplicationUser", b =>
                {
                    b.HasOne("TaskProject.Class", "Class")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskProject.GuildsReputation", b =>
                {
                    b.HasOne("TaskProject.Guild", "Guild")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskProject.MissionsCondition", b =>
                {
                    b.HasOne("TaskProject.Mission", "Mission")
                        .WithMany()
